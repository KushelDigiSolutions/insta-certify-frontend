...
export default function Navbar(props) {
  ...
  if (typeof props.navbarProps == "undefined" || props.navbarProps == false) {
    ...
    return (
      <header id='lower_head' className={style.header} style={itemsSetting} role="banner">
        <div className='nav_cont'>
          <div className=''>
            <div id='some' className={style.headerParent}>
              ...
              <div id='right_men' className={menuToggel == true ? style.hpRight + " " + style.isMenuOpen : style.hpRight}>
