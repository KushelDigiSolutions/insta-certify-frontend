              ...
              <div className="row rwing">
                  ...
                  <div className="widget widget_getintuch" height="240px">
                    ...
                    <ul className="contactus-footer font-opensans">
                      ...
                      <li >
                        ...
                        <span className='bas'>+91 9999118039</span>
                      </li>
                      <li>
                        <div className='cort'>
                        ...
                        <span className='bas bask1'>Contact@instacertify.com</span>
                      </li>
                    </ul>
                  ...
                  <div className="widget">
                    ...
                    <ul className="list-2 font-opensans lopl">
                      ...
                      <li>
                        ...
                        <a href="/foreign-manufacturers-certification-scheme-fmcs.php">
                ...
                <div className="col-md-3 col-sm-12">
                  <div className="widget">
                    ...
                    <ul
                      className="imagesmsme iq-greyscale-max"
                    >
