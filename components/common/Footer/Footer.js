                ...
                <div className="rwing1">
                  <div className="widget widget_getintuch" height="240px">
                    <div className='foot_logs'>
                        <img src='https://res.cloudinary.com/dgif730br/image/upload/v1737628832/Layer_1_2_wfwmlq.svg' alt='hh'/>
                    </div>
                  ...
                  <h4 className="footer-title jk_tit">Qr Code</h4>
                  <img className='qr_png' width="80"  src='./images/qr.png'/>
                  <div className='payments_footering'>
                  <h4 className="footer-title jk_tit">Payments</h4>
...
>
  ...
  <img className='razor_pay' width="170" src="https://res.cloudinary.com/dgif730br/image/upload/v1737633038/Group_1171276061_cho16w.svg" alt=''/>
 
  </div>
</ul>
                  </div>
                  <div className='svg_flex111'>
                  <h4 className="footer-title jk_tit">Social Links</h4>
                  <div className='svg_flex svg_flex11'>
    <a href='https://www.facebook.com/share/15NtSiGZq8/?mibextid=wwXIfr' target='_blank' ><svg width="10" height="20" viewBox="0 0 10 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href='https://x.com/instacertify?s=11' target='_blank'>
...
>
  ...
  />
    ...
    <a href='https://www.linkedin.com/company/instacertify' target='_blank'><svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
   ...
   <a href='https://pin.it/37GLjxHab'><img className='pinterest' width="21" height="20" src='./images/pint.svg'/></a>
...
<ul
  className="imagesmsme iq-greyscale-max somisk mlol"
>

  <div className='svg_flex'>
  <img className='razor_logo' src="https://res.cloudinary.com/dgif730br/image/upload/v1737633038/Group_1171276061_cho16w.svg" alt=''/>
  <img  className='qr_png' width="80"  src='./images/qr.png'/>
  </div>
</ul>
</div> */}
    ...
    <a href='https://x.com/instacertify?s=11' target='_blank'> <svg width="21" height="17" viewBox="0 0 21 17" fill="none" xmlns="http://www.w3.org/2000/svg">
